...
object OpcodesRefactor {
    ...
    val map: Map<Int, Opcode> = buildMap {
        ...
        put(0x93, Ahx(IndirectY, 6, "AHX (ind),Y"))
        put(0x9F, Ahx(Absolute(y = true), 5, "AHX abs,Y"))
        ...
        put(0xC7, Dcp(ZeroPage(), 5, "DCP zp"))
        put(0xD7, Dcp(ZeroPage(x = true), 6, "DCP zp,X"))
        put(0xCF, Dcp(Absolute(), 6, "DCP abs"))
        put(0xDF, Dcp(Absolute(x = true), 7, "DCP abs,X"))
        put(0xDB, Dcp(Absolute(y = true), 7, "DCP abs,Y"))
        put(0xD3, Dcp(IndirectX, 8, "DCP (ind,X)"))
        put(0xE3, Dcp(IndirectX, 8, "DCP (ind,X)"))

        // ===== ISC (6) — 0xF3 stays ISC; 0xE3 moved to DCP ==============
        put(0xE7, Isc(ZeroPage(), 5, "ISC zp"))
        put(0xF7, Isc(ZeroPage(x = true), 6, "ISC zp,X"))
        put(0xEF, Isc(Absolute(), 6, "ISC abs"))
        put(0xFF, Isc(Absolute(x = true), 7, "ISC abs,X"))
        put(0xFB, Isc(Absolute(y = true), 7, "ISC abs,Y"))
        put(0xF3, Isc(IndirectY, 8, "ISC (ind),Y"))

        // ===== RLA (7) ====================================================
        put(0x27, Rla(ZeroPage(), 5, "RLA zp"))
        put(0x37, Rla(ZeroPage(x = true), 6, "RLA zp,X"))
        put(0x2F, Rla(Absolute(), 6, "RLA abs"))
        put(0x3F, Rla(Absolute(x = true), 7, "RLA abs,X"))
        put(0x3B, Rla(Absolute(y = true), 7, "RLA abs,Y"))
        put(0x23, Rla(IndirectX, 8, "RLA (ind,X)"))
        put(0x33, Rla(IndirectY, 8, "RLA (ind),Y"))

        // ===== RRA (7) ====================================================
        put(0x67, Rra(ZeroPage(), 5, "RRA zp"))
        put(0x77, Rra(ZeroPage(x = true), 6, "RRA zp,X"))
        put(0x6F, Rra(Absolute(), 6, "RRA abs"))
        put(0x7F, Rra(Absolute(x = true), 7, "RRA abs,X"))
        put(0x7B, Rra(Absolute(y = true), 7, "RRA abs,Y"))
        put(0x63, Rra(IndirectX, 8, "RRA (ind,X)"))
        put(0x73, Rra(IndirectY, 8, "RRA (ind),Y"))

        // ===== SLO (7) ====================================================
        put(0x07, Slo(ZeroPage(), 5, "SLO zp"))
        put(0x17, Slo(ZeroPage(x = true), 6, "SLO zp,X"))
        put(0x0F, Slo(Absolute(), 6, "SLO abs"))
        put(0x1F, Slo(Absolute(x = true), 7, "SLO abs,X"))
        put(0x1B, Slo(Absolute(y = true), 7, "SLO abs,Y"))
        put(0x03, Slo(IndirectX, 8, "SLO (ind,X)"))
        put(0x13, Slo(IndirectY, 8, "SLO (ind),Y"))

        // ===== SRE (7) ====================================================
        put(0x47, Sre(ZeroPage(), 5, "SRE zp"))
        put(0x57, Sre(ZeroPage(x = true), 6, "SRE zp,X"))
        put(0x4F, Sre(Absolute(), 6, "SRE abs"))
        put(0x5F, Sre(Absolute(x = true), 7, "SRE abs,X"))
        put(0x5B, Sre(Absolute(y = true), 7, "SRE abs,Y"))
        put(0x43, Sre(IndirectX, 8, "SRE (ind,X)"))
        put(0x53, Sre(IndirectY, 8, "SRE (ind),Y"))
